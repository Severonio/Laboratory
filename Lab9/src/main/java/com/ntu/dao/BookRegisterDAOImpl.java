...
public class BookRegisterDAOImpl implements BookRegisterDAO {
	...
	public BookRegister getBookRegisterById(long id) {
        ...
        try (Connection connection = ConnectionFactory.getConnection();
            ...
            if(rs.next())
            {
               ///��� �������� ��������� ����� ��� � ��������� ����� extractBookRegisterFromResultSet
            	/*
	...
	public List<BookRegister> getBookRegisterByVydanoDt(Date vydanoDt) {
	        	...
	        	PreparedStatement ps = connection.prepareStatement("SELECT * FROM bookRegister WHERE vydanoDt=? "))
	        {
	            ...
	            while(rs.next())
	            {
                   ...
                   bookRegisters.add(bookRegister);  //������ 
	            }
	...
	@Override
	public List<BookRegister> getAllBookRegistersNepoverneni() {

		//try-with-resources
		try (Connection connection = ConnectionFactory.getConnection();
			 Statement stmt = connection.createStatement();
			 ResultSet rs = stmt.executeQuery("SELECT * FROM bookRegister where povernenoDt is null");
		)
		{
	...
	@Override
	public List<BookRegister> getAllBookRegistersPoverneni() {

		//try-with-resources
		try (Connection connection = ConnectionFactory.getConnection();
			 Statement stmt = connection.createStatement();
			 ResultSet rs = stmt.executeQuery("SELECT * FROM bookRegister where povernenoDt is not null");
		)
		{
