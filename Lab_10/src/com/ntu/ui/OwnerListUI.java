...
public class OwnerListUI extends BorderPane {
    ...
    private TableColumn<OwnerList, String> firstNameColumn = new TableColumn<OwnerList, String>("��'�");
    private TableColumn<OwnerList, String> middleNameColumn = new TableColumn<OwnerList, String>("��-�������");
    private TableColumn<OwnerList, String> lastNameColumn = new TableColumn<OwnerList, String>("�������");
    private TableColumn<OwnerList, String> phoneColumn = new TableColumn<OwnerList, String>("�������");
    private TableColumn<OwnerList, Date> birthDtColumn = new TableColumn<OwnerList, Date>("���� ����������");
    private TableColumn<OwnerList, String> addressColumn = new TableColumn<OwnerList, String>("������");
    ...
    private Pane initTable() {
        ...
        ownerListTable.getColumns().addAll(idColumn, firstNameColumn, middleNameColumn, lastNameColumn, phoneColumn, birthDtColumn,  addressColumn );
        ...
        public void handle(ActionEvent e) {
            ...
            if (e.getSource().equals(createButton)
                ...
                if (ownerListDAO.updateOwnerList(ownerList))
                    msgLabel.setText("OwnerList with ID:"
    ...
    private void refreshTable() {
        ...
        TableViewFocusModel<OwnerList> ownerModelFocused =  ownerListTable.getFocusModel();
        setTabledData();
        ownerListTable.setFocusModel(ownerModelFocused);
